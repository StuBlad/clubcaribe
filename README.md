...
Whilst Habitat was breaking new ground, Q-Link decided to strip the more esoteric elements from the world database, shipping it as "Club Caribe" where it was touted as an idyllic island getaway destination. Caribe was a heavily modified version of regions used in the original Habitat world, along with a bunch of freshly created regions especially for it. So you will see several regions that are either identical to their original Habitat counterparts when examining historical data.

As far as we know, there are no database backups that exist of Club Caribe out there. If you worked at AOL or Q-Link and are aware of such things, please get in touch.

We have a lot of screenshots, maps and video footage of Club Caribe and with that, I'd like to work on recreating that world by hand. If you would like to contribute, please join the [Reno Project Discord](https://discord.gg/xagN9ay3pB) and feel free to submit a pull request.
...
* Database backup of Club Caribe (The Holy grail. Likely doesn't exist anymore)
...
## How to Collaborate
Using the tools and resources below, select a region from the [screenshot library containing Club Caribe regions](https://renoproject.org/imagearchive/index.php?/category/277) and [check to see if it has already been created](https://github.com/StuBlad/clubcaribe/tree/master/db). If it hasn't been worked on, [create the region using our in browser region creation and editing tool](https://frandallfarmer.github.io/neohabitat-doc/inspector/edit.html), [check it for any issues](https://github.com/frandallfarmer/neohabitat/wiki/Region-testing-procedure) and then submit a pull request. I will review all PR's and check your region out for any issues and if it's good to go, then it'll be merged into this repository.

Stubs have been made for regions that we know exist and have a screenshot of. These allow you to import this repository into your NeoHabitat server instance, remove the original Habitat regions and not only move around the world unimpeded even if a region doesn't exist yet, but you can also use it as a template to build upon as it's already hooked up to the world map.

To avoid any duplication of work, I highly recommend that you join the [Reno Project Discord](https://discord.gg/xagN9ay3pB) and look in the #clubcaribe channel to see if anyone else is already working on that region or area.
...
### Tools
* [SpindleyQ's Habitat inspector tool](https://frandallfarmer.github.io/neohabitat-doc/inspector/edit.html) - This lets you create NeoHabitat regions in your browser. You can load pre-existing regions from the Habitat region database, load a screenshot of a Caribe region to use as an overlay with a transparency slider so you can compare your modifications in real time. Once you've built the region, you can export the regions JSON file and submit it as a Pull Request.
